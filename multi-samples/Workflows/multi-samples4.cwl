...
steps:
  joint-variant-calling:
    ...
    in:
      ...
      interval_bed_list:
        source: list_list
        valueFrom: $(self.interval_bed_list)
      # gather_outprefix: gather_outprefix
      # for GatherVcfs
      gatk4-GatherVcfs_java_options: gatk4-GatherVcfs_java_options
      gathervcfs_outprefix:
        source: list_list
        valueFrom: $(inputs.interval_bed_list.aaa)
  ...
  vqsr:
    ...
    in:
      ...
      vcfs: joint-variant-calling/gathered_vcf
